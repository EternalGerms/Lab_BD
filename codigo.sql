...
VALUES(1, "Joao", 40, "ortopedia", 12345678901, "Florianopolis", 1),
...
VALUES(1, "Ana", 20, 09876543210, "Florianopolis", "gripe"),
...
VALUES(1, "Rita", 32, "Sao Jose", 1200, 74185296301),
...
UPDATE Consultas SET DATA = "2006-07-04",
HORA = "12:00" WHERE codm = 4 AND codp = 1;
...
UPDATE Consultas SET hora = NULL,
DATA = NULL WHERE hora = "19:00";
UPDATE Pacientes SET nomep = NULL,
idade = NULL,
cpf = NULL,
doenca = NULL,
