...
ALTER TABLE Pacientes CHANGE "idade" "IDADE_PACIENTE" SMALLINT NOT NULL; 
ALTER TABLE Funcionarios CHANGE "idade" "IDADE_FUNCIONARIO" SMALLINT NOT NULL; 
ALTER TABLE Medicos CHANGE "idade" "IDADE_MEDICO" SMALLINT NOT NULL;
